...
```bash
bitasmbl pull --repoUrl https://github.com/he1snber8/Bitasmbl_bookingmanager_472_447 --appId 447 --repoId 305
```

## 3) Enter into the main directory and start coding!

```bash
cd Bitasmbl_bookingmanager_472_447
```
...
{"Requirement":"Set up Ember routing","Paths":["**/app/routes/**","**/app/templates/**","**/app/router.js"]}
